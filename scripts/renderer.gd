...
@onready var pump_texture: Texture2D = preload("res://resources/item_textures/pump.png")
@onready var particle_texture: Texture2D = preload("res://resources/particle_textures/particle.png")
@onready var wall_texture: Texture2D = preload("res://resources/item_textures/wall.png")
@onready var diode_texture: Texture2D = preload("res://resources/item_textures/diode.png")
@onready var spawner_texture: Texture2D = preload("res://resources/item_textures/spawner.png")
@onready var conductor_texture: Texture2D = preload("res://resources/item_textures/conductor.png")
